...
resource "aws_iam_role" "ecs_execution" {
  ...
  name  = "${var.ecs_role_name}-${terraform.workspace}"
...
resource "aws_iam_role_policy" "ecs_inline" {
  count = var.create_ecs_execution_role ? 1 : 0
  name  = "${var.ecs_policy_name}-${terraform.workspace}"
      ...
      },
      {
        ...
        Resource = [
          format(
            ...
            "${var.ecr_repo_name}-${terraform.workspace}"
          )
        ]
      },
      {
...
resource "aws_iam_role" "flow_logs" {
  ...
  name  = "${var.flow_logs_role_name}-${terraform.workspace}"
...
resource "aws_iam_role_policy" "flow_logs" {
  count = var.create_flow_logs_role ? 1 : 0
  name  = "${var.flow_logs_role_name}-policy-${terraform.workspace}"
